...
struct ExtensionInspectorView: View {
    ...
    private var context: MusicContext { controller.musicContext }
    ...
    var body: some View {
        Form {
            ...
            Section {
                Text("This panel only observes a read-only projection of music state and submits commands. It’s the boundary future extensions plug into.")
                    .font(.caption)
