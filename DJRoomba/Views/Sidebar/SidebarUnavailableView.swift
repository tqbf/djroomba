  ...
  var body: some View {
    ...
    case .libraryNotSynced:
      ContentUnavailableView {
        ...
        Text(
          "Turn on Sync Library in the Music app (Music ▸ Settings ▸ General ▸ Sync Library) so DJ Roomba can import your Apple Music playlists. You can still create your own playlists here."
        )
      } actions: {
    ...
    case .subscriptionNeeded:
      ContentUnavailableView {
        ...
        Text(
          "An active Apple Music subscription is required to import and play your library. You can still create your own playlists here."
        )
      } actions: {
        Button("New Playlist", action: createPlaylist)
      }
    ...
    case .noImportedPlaylists:
      ContentUnavailableView {
        ...
        Text(
          "No Apple Music playlists were found in your library. Create your own playlist to get started, or refresh to import again."
        )
      } actions: {
        Button("New Playlist", action: createPlaylist)
