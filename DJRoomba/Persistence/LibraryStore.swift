...
struct LibraryStore: Sendable {
    ...
    // MARK: - Apple playlist snapshots (one-way import)
    ...
    // MARK: - App playlists (user-owned, SQLite-only)
    ...
    // MARK: - Songs + play stats (the track table's sortable columns)
    ...
    // MARK: - Favorites (replaces UserDefaults FavoritesStore)
    ...
    // MARK: - Recents (replaces UserDefaults RecentlyPlayedStore)
