...
final class PlaybackResolver {
    ...
    // MARK: - Phase-3 imported-playlist re-resolution (the proven path)
    ...
    // MARK: - Phase-4 app-playlist re-resolution (per-song, 1:1)
    ...
    // MARK: - MusicKit re-fetch — catalog (dormant)
    //
    ...
    // MARK: - Pure logic (unit-tested without MusicKit)
