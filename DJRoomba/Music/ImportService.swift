...
final class ImportService {
    ...
    // MARK: - Library playlist paging (proven M1 loop)
    ...
    // MARK: - Per-playlist track paging (serial, proven M1 loop)
    ...
    // MARK: - Per-playlist write (serial, isolation unchanged)
    ...
    // MARK: - Mapping (Track → stored Song)
